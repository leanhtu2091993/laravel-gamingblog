<nav class="navbar navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-brand">
            <a href="index.html">
                <img src="/st-admin/assets/images/logo-icon.svg" alt="Mplify Logo" class="img-responsive logo">
                ...
                <li>
                    <div id="navbar-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                <a href="javascript:void(0);" class="dropdown-toggle icon-menu" data-toggle="dropdown">
                                    <img class="rounded-circle" src="/st-admin/assets/images/user-small.png" width="30" alt="">
                                </a>
                                <div class="dropdown-menu animated flipInY user-profile">
                                    <div class="d-flex p-3 align-items-center">
                                        <div class="drop-left m-r-10">
                                            <img src="/st-admin/assets/images/user-small.png" class="rounded" width="50" alt="">
                                        </div>
