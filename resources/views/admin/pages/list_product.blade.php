        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover m-b-0 c_list">
                                    ...
                                    <tr>
                                        ...
                                        <th width="30%">Ảnh đại diện bài viết</th>
                    ...
                    <a href="{{route('admin.add_product')}}"> <button type="button" class="btn btn-warning"><i class="fa fa-plus-square"></i> <span>Thêm bài viết mới</span></button></a>
                </div>
            </div>
        </div>
    </div>
