                                ...
                                <div class="product-list">
                                    <div class="media">
                                        <a class="pull-left media-link" href="#">
                                            <img class="media-object" src="/st-store/assets/img/preview/shop/top-sellers-2.jpg" alt="">
                                    ...
                                    <div class="media">
                                        <a class="pull-left media-link" href="#">
                                            <img class="media-object" src="/st-store/assets/img/preview/shop/top-sellers-3.jpg" alt="">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                        <div class="media-body">
                                            <h4 class="media-heading"><a href="#">Standard Product Header</a></h4>
